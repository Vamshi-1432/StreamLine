...
const TvShows = () => {
  ...
  return (
    <div>
      ...
      <div className="from-black bg-gradient-to-tr xs:px-[2%] xs:pb-[50vh] xs:-mt-[28vh] sm:px-[3%] md:px-[4%] md:pb-[20vh] md:-mt-[20%] lg:mt-[5%] lg:pb-[54vh] lg:px-10 xl:-mt-10 xl:pb-[20vh]">
        <TvShowList />
      </div>
    </div>
  );
